...
In MemoPad, make '= HappyDays Notes' note. In this memo, you can predefined note string for each
...
You can omit the year field. If you are not sure of the year format, just write it in form of
